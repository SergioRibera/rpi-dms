...
in
{
  home-manager.users.${user.username}.programs.hyprland = {
    enable = true;
    withUWSM = true;
    ...
    settings = {
      ...
      bind = [
        ...
        #
        "SUPER,Return,exec,${command} ${shell.command}"
        "SUPER,E,exec,nautilus"
        "SUPER,Tab,global,caelestia:launcher"
